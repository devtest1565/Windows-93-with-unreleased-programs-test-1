system42("desktop", function (le) {
  ...
  le._temp.defaultDesk = [
    ...
    {
      name: "ANSI Love.lnk42",
      exe: "ansi",
      icon: "apps/ansilove.png",
      row: 2,
      col: 4,
    },
    {
      name: "ASCII Gallery.lnk42",
      exe: "ascii",
    ...
    },
    {
      name: "Recorder.lnk42",
      exe: "recorder",
      icon: "/c/sys/skins/w93/apps/recorder.png",
      row: 2,
      col: 8,
    },
    ...
    },
    {
      ...
      title: "Pokéğ̭̤ͬ̋ͭͬ̏ͪl̥̠ͦiṫ͚̠͇̠̮̯̍ͬ͗̂c̙ͭ͛̄h̫̦ͯ͆ͯ̀̓̂ͫ",
      icon: "apps/helix.png",
      row: 5,
      col: 2,
    },
    ...
    {
      name: "Arena 93 multiplayer.lnk42",
      exe: "arena93",
      row: 7,
      col: 3,
    },
    ...
    {
      name: "Love letter.lnk42",
      exe: "iframe /love_letter.html --height=300",
      icon: "/c/files/images/icons/loveletter.png",
      row: 100,
      col: 1,
    },
    {
      name: "Shop.lnk42",
      exe: "js window.open('https://shop.windows93.xyz/')",
      icon: "/c/files/images/icons/gift.png",
      row: 100,
      col: 2,
    },
    {
      name: "V3 Roadmap.lnk42",
      exe: "iframe /roadmap.html --height=432",
      icon: "/c/files/images/icons/roadmap.png",
      row: 100,
      col: 3,
    },
